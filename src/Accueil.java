...
public class Accueil extends JFrame {
	...
	public Accueil(){
		...
		this.setTitle("Jean Service Location ");
		...
		bon_de_reservation.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					try {
						Reserva l = new Reserva(null, "R�servation : Informations V�hicule", true);
					} catch (RemoteException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
...
JLabel lib4 = new JLabel("Vehicule reserv�s:");
JLabel lib3 = new JLabel("Vehicule sorties:" );
JLabel lib6 = new JLabel("Nombre de r�servation:");
...
bdd.addActionListener(new ActionListener(){
	...
	public void actionPerformed(ActionEvent arg0) {
		BDD zd = new BDD(null, "Param�tres : Informations base de donn�e", true);
...
this.setContentPane(split);
	...
	public static void main(String[] args) throws UnknownHostException, MalformedURLException, RemoteException, NotBoundException, InterruptedException{
		BDD zd = new BDD(null, "Etape 1/2 : Configuration de la base de donn�e", true);
...
private Color fondBouton = Color.white;
	 ...
	 private void initToolBar(){
		 ...
		 icone_reserva.setToolTipText("Faire une nouvelle r�servation");
		 change_onglet.setToolTipText("Changer la position de l'onglet");
		 reservee.setToolTipText("Afficher la liste des r�servation");
		 facture1.setToolTipText("Afficher la liste des factures");
		 client_attente.setToolTipText("Afficher la liste des clients ayant r�serv�");
		 client_contrat.setToolTipText("Afficher la liste des clients sous contrats");
		 reserve.setToolTipText("Afficher la liste des vehicules en r�servation");
 	...
 	synchronized public void marques() throws RemoteException {
 		...
 		try {
 			Location l = new Location(null, "Contrat : Informations V�hicule", true);
